...
namespace 随机抽取学号.Views
{
    public sealed partial class SwitchClassContentDialog : ContentDialog
    {
        ...
        private void AddClassButton_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private void DeleteClassButton_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private void RenameClassButton_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
